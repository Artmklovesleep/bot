import { version, ref, watchEffect, watch, getCurrentInstance, toRaw, isRef, isReactive, toRef, defineComponent, provide, createElementBlock, defineAsyncComponent, h, inject, computed, unref, shallowReactive, Suspense, nextTick, Transition, hasInjectionContext, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onScopeDispose, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, toRefs, markRaw, isShallow, withCtx } from 'vue';
import { $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, n as joinURL, o as defuFn, q as klona, r as defu, t as sanitizeStatusCode, v as createDefu, x as createHooks, h as createError$1, y as isSamePath, z as toRouteMatcher, A as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-DkenPO4L.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-LhNy2ogI.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-Ct1IPsCO.mjs').then((r) => r["default"] || r.default || r));
...
const _flamingo = { "50": "#FDEDED", "100": "#FCDADA", "200": "#F9B5B5", "300": "#F58F8F", "400": "#F26A6A", "500": "#EF4444", "600": "#E71414", "700": "#B30F0F", "800": "#800B0B", "900": "#4C0707", "950": "#320404", "DEFAULT": "#EF4444" };
const _mountain = { "50": "#8CF5D2", "100": "#79F3CB", "200": "#53F0BC", "300": "#2EEDAE", "400": "#13DF9B", "500": "#10B981", "600": "#0C855D", "700": "#075239", "800": "#031E15", "900": "#000000", "950": "#000000", "DEFAULT": "#10B981" };
...
const layouts = {
  default: () => import('./default-DHzcnDDt.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-jTxHdlq0.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CB71vLfu.mjs').then((r) => r.default || r));
...
export { API as A, _export_sfc as _, useAppConfig as a, appConfig as b, useState as c, defineStore as d, entry$1 as default, __nuxt_component_0$1 as e, useRouter as f, useRuntimeConfig as g, navigateTo as h, useNuxtApp as i, mergeConfig as m, nuxtLinkDefaults as n, storeToRefs as s, useHead as u };
