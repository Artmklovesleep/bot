import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, toRaw, isRef, isReactive, markRaw, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, defineAsyncComponent, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-DkenPO4L.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-LhNy2ogI.js").then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-Ct1IPsCO.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import("./_nuxt/default-DHzcnDDt.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-jTxHdlq0.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CB71vLfu.js").then((r) => r.default || r));
